...
let s:normal_l1_fg = [ '#005f00', '22' ]      " s:palette.bg0
let s:normal_l1_bg = [ '#afdf00', '148' ]     " s:palette.bg_green
let s:normal_l2_fg = s:palette.fg
let s:normal_l2_bg = s:palette.bg4
let s:normal_r1_fg = s:palette.bg0
let s:normal_r1_bg = s:palette.fg             " s:palette.bg_green
...
let s:insert_l1_fg = [ '#005f5f', '23' ]      " s:palette.bg0
let s:insert_l1_bg = [ '#ffffff', '231' ]     " s:palette.bg_blue
let s:insert_l2_fg = [ '#ffffff', '231' ]     " s:palette.fg
let s:insert_l2_bg = [ '#0087af', '31' ]      " s:palette.bg4
let s:insert_r1_fg = [ '#005f5f', '23' ]      " s:palette.bg0
let s:insert_r1_bg = [ '#87dfff', '117' ]     " s:palette.bg_blue
let s:insert_r2_fg = [ '#87dfff', '117' ]     " s:palette.fg
let s:insert_r2_bg = [ '#0087af', '31' ]      " s:palette.bg4
let s:insert_middle_fg = [ '#87dfff', '117' ] " s:palette.fg
let s:insert_middle_bg = [ '#005f87', '24' ]  " s:palette.bg1

let s:visual_l1_fg = [ '#870000', '88' ]      " s:palette.bg0
let s:visual_l1_bg = [ '#ff8700', '208' ]     " s:palette.orange
...
let s:replace_l1_fg = [ '#ffffff', '231' ]    " s:palette.bg0
let s:replace_l1_bg = [ '#df0000', '160' ]    " s:palette.bg_red
let s:replace_l2_fg = s:palette.fg
let s:replace_l2_bg = s:palette.bg4
let s:replace_r1_fg = s:palette.bg0
let s:replace_r1_bg = s:palette.bg_red
